...
glEnd();*/
	...
	//Orejas
		//izquierda
	glBegin (GL_POLYGON);
		glVertex3f (-2.8,2.0,0.1);
		glVertex3f (-2.0,2.0,0.1);
		glVertex3f (-2.0,4.0,0.1);
		glVertex3f (-2.8,4.0,0.1);
	glEnd ( );
		//derecha
	glBegin (GL_POLYGON);
		glVertex3f (2.0,2.0,0.1);
	...
	Circle(0.5,-0.8,4,0.1,20,GL_FILL);
	Circle(0.5,0.8,4,0.1,20,GL_FILL);
	...
	glBegin (GL_TRIANGLES);
		glVertex3f (-0.7,2.2,0.1);
		glVertex3f (0.7,2.2,0.1);
		glVertex3f (0,3.2,0.1);

	glEnd ( );

	//Boca
	glColor3f(1.0,0.7,0.0);
	Circle(0.3,-0.8,1.0,0.1,20,GL_FILL);
	Circle(0.3,0.8,1.0,0.1,20,GL_FILL);
	glBegin (GL_POLYGON);

		glVertex3f (-0.8,0.7,0.1);
		glVertex3f (0.8,0.7,0.1);
		glVertex3f (0.8,1.3,0.1);
		glVertex3f (-0.8,1.3,0.1);
